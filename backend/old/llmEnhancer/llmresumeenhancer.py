...
# Initialize Groq client (set your API key here or via environment variable GROQ_API_KEY)
client = Groq(api_key="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")
