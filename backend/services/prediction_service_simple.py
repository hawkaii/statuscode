"""
Simple deployment version of prediction service without NumPy dependency
"""
...
class PredictionService:
    """University admission prediction service (simplified for initial deployment)"""
    ...
    def _predict_single_university(self, profile: AcademicProfile, university: Dict[str, Any]) -> UniversityPrediction:
        """Predict admission probability for a single university (simplified without NumPy)"""
        
        # Simplified prediction algorithm without NumPy
        base_score = 0.0
        requirements_met = {}
        ...
        # Add some randomness to simulate real-world variability (without NumPy)
        noise = (random.random() - 0.5) * 0.1  # Random between -0.05 and 0.05
    ...
    def _load_university_data(self) -> List[Dict[str, Any]]:
        """Load university database (simplified for initial deployment)"""
        return [
            {
                "name": "MIT",
                "ranking": 1,
    ...
    def get_health(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "note": "Running in simplified mode without NumPy for Railway compatibility"
        }