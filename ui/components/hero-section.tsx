  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-background pt-16 sm:pt-20">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute bottom-32 sm:bottom-40 left-4 sm:left-20 w-14 sm:w-20 md:w-28 lg:w-40 h-14 sm:h-20 md:h-28 lg:h-40 bg-accent neo-border neo-shadow rotate-45 neo-animate-shake" />
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div className="hidden md:block absolute top-24 lg:top-32 left-20 lg:left-32 text-secondary font-black text-base sm:text-lg lg:text-2xl uppercase neo-text-shadow -neo-rotate opacity-80">
          SMART AI
        </div>
        ...
        <div className="hidden md:block absolute top-20 lg:top-28 right-20 lg:right-32 text-primary font-black text-base sm:text-lg lg:text-2xl uppercase neo-text-shadow neo-rotate opacity-80">
          AI POWERED
        </div>
        ...
        <div className="hidden xl:block absolute top-1/3 right-4 text-primary font-black text-sm lg:text-lg uppercase neo-text-shadow -rotate-90 opacity-60">
          FUTURE
        </div>
      </div>
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="absolute top-1/2 left-1/2 transform -translate-x-75 -translate-y-124 z-20 mt-2 sm:mt-4 lg:mt-6 -ml-12 sm:-ml-16 lg:-ml-20">
        ...
        <div className="text-center">
          <div className="space-y-6 sm:space-y-8 lg:space-y-10">
            ...
            <div className="bg-foreground text-background neo-border neo-shadow-lg p-3 sm:p-5 lg:p-7 xl:p-10 max-w-5xl mx-auto neo-skew">
            ...
            {/* Feature icons - Slightly Smaller */}
